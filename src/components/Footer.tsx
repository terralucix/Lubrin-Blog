  ...
  return (
    <footer className="bg-white border-t">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p> Descubre Lubrín, un tesoro escondido en la Sierra de los Filabres, Almería. Este blog explora la rica historia, tradiciones y vida actual de nuestro pueblo blanco andaluz, compartiendo información sobre turismo rural, alojamientos, eventos culturales, festividades, gastronomía tradicional, rutas de naturaleza, historia, patrimonio y actualidad local. Desde la arquitectura árabe hasta la gastronomía local, pasando por sus fiestas populares y rutas de senderismo, te mostramos todo lo que hace único a este rincón mediterráneo. Un espacio digital para vecinos, visitantes y amantes de la auténtica Andalucía interior.</p>
